import { FaHome, FaMapMarkerAlt, FaEdit, FaTrash, FaUser } from "react-icons/fa";
import { useState } from "react";
import GererMembresModal from "./GererMembresModal";

export default function FamilleCard({ famille, onEdit, onDelete, onRefresh }) {
